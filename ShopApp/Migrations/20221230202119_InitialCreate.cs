    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Products", x => x.VendorCode);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<int>(type: "int", nullable: false),
                    ProductVendorCode = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Favourites", x => new { x.UserId, x.ProductVendorCode });
                    table.ForeignKey(
                        name: "FK_Favourites_Products_ProductVendorCode",
                        column: x => x.ProductVendorCode,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceWithSale = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItems_Products_ProductVendorCode",
                        column: x => x.ProductVendorCode,
                        principalTable: "Products",
                        principalColumn: "VendorCode");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favourites_ProductVendorCode",
                table: "Favourites",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_ProductVendorCode",
                table: "OrderItems",
                column: "ProductVendorCode");
